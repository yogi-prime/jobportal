...
<footer id="colophon" class="jobportal-footer-modern">
    <!-- Main Footer -->
    <div class="jobportal-footer-main" style="background: #0f172a; padding: 80px 0 40px; position: relative; overflow: hidden;">
        <!-- Background Pattern -->
            ...
            <div style="display: grid; grid-template-columns: 1.8fr 1fr 1fr 1fr 1.2fr; gap: 50px; margin-bottom: 60px;">
                ...
                <div class="jobportal-footer-brand">
                    <div class="footer-logo" style="margin-bottom: 28px;">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/logo-vertical.png'); ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?>" style="height: 90px; width: auto; filter: brightness(0) invert(1);">
                    </div>
                    ...
                    <div style="display: flex; gap: 24px; padding-top: 20px; border-top: 1px solid rgba(255, 255, 255, 0.1);">
                        <div>
                            <div style="font-size: 24px; font-weight: 800; color: #00b4d8; margin-bottom: 4px;">2.5M+</div>
                            <div style="font-size: 12px; color: #64748b;">Jobs</div>
                        </div>
                        <div>
                            <div style="font-size: 24px; font-weight: 800; color: #00b4d8; margin-bottom: 4px;">50K+</div>
